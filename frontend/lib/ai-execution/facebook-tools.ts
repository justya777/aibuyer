        ...
        properties: {
          ...
          creative: {
            ...
            properties: {
              ...
              imageUrl: { type: 'string', description: 'Image URL (optional, prefer imageHash for direct uploads)' },
              imageHash: { type: 'string', description: 'Facebook image hash from upload_ad_image (preferred over imageUrl)' },
              videoUrl: { type: 'string', description: 'Video URL (optional, prefer videoId for direct uploads)' },
              videoId: { type: 'string', description: 'Facebook video ID from upload_ad_video (preferred over videoUrl)' },
